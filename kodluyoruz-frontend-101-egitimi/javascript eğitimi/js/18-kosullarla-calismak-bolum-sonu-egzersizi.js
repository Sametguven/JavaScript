...
if (examGrade >= 0 && examGrade <= 100) {
    ...
    if (examGrade >= 90) {
        ...
        textInfo = `${FROWN} FF` //Burada neden artı koymadık?cevabı biliyoruz

        info.classList.remove('text-primary')//Class'ı kaldırmasak da alttaki class çalışıyor.//Sebebi:Kod yukarıdan aşağıya okunuyor ve classList.add olarak son değer text-danger atanıyor.
