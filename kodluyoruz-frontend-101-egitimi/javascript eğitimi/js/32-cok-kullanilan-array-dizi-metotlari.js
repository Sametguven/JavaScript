...
let newItems = items.splice(1, 5) //1.indeks den başla, 5 eleman al
...
copyItems = items.slice() // copyItems'in verileri items' e kopyalandı
copyItems.pop() // son ogeyi cikarttik
console.log("copyItems", copyItems)
console.log("items", items)
...
//Burada kopyalama islemini ... yapar.
...
console.log(allUsers)
//Burada 0 anlamı parcalamayacaksin demek.